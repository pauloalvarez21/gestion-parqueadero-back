...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleNoResourceFound(NoResourceFoundException ex, WebRequest request) {
        return buildErrorResponse("La ruta solicitada no existe", HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(BadCredentialsException.class)
    public ResponseEntity<?> handleBadCredentials(BadCredentialsException ex, WebRequest request) {
        return buildErrorResponse("Usuario o contraseña incorrectos", HttpStatus.UNAUTHORIZED);
    }
